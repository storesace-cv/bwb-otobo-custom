...
CREATE TABLE `bwb_work_session` (
  ...
  `finish_latitude` decimal(10,7) DEFAULT NULL,
  `finish_longitude` decimal(10,7) DEFAULT NULL,
  `finish_accuracy_m` decimal(10,2) DEFAULT NULL,
  `finish_location_source` varchar(16) DEFAULT NULL,
  `finish_location_note` text DEFAULT NULL,
