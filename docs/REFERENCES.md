...
- Saudações (concatenadas antes do modelo no Compose): [https://doc.otobo.org/manual/admin/11.0/en/content/administration-area/ticket-settings/salutations.html](https://doc.otobo.org/manual/admin/11.0/en/content/administration-area/ticket-settings/salutations.html)
