...
| Manuais internos Ajuda (FAQ agente) | Helpdesk: `db/faq-content/`; PTcert: `db/ptcert-content/` + `scripts/build-ptcert-faq.py` / `scripts/apply-ptcert-faq.py` — ver [FEATURES.md](FEATURES.md) § Ajuda |
