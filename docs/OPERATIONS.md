...
POS Helpdesk: `mysqldump` + `db/migrations/2026-09-17-pos-helpdesk-device.sql` e `db/migrations/2026-09-17-aocert-helpdesk.sql`, depois o deploy. Teste `public.pl?Action=PublicBWBPos;Subaction=Ping`. Ficha Agent: Operação → Heldesk AOcert.
